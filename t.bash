...
name=$1
declare name=$1
declare cname="$namepr2017.azurewebsites.net"
...
az webapp create -g pr2017 -p ServicePlane0ceef23-bd0a -n $name --runtime "PHP|7.0" --deployment-source-url https://github.com/jura120596/pr08
